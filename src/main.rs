...
fn tree(mut tokens: Vec<Token>) -> InterResult<'a> {
    loop {
        
    }
}

fn tree_until_plus_minus(mut tokens: Vec<Token>) -> InterResult<'a> {
    loop {

    }
}

fn tree_until_times_div(mut tokens: Vec<Token>) -> InterResult<'a> {
    loop {
